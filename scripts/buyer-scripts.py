...
# requests.post('http://127.0.0.1:8000/api/v1/buyers/',json={'name':'Aleksey','surname':'Telpuk'
#     ,'email':'maximad76@gmail.com','phoneNumber':'375257909472','buyerId':'121','balance':'1000000000'},
#               headers={"Authorization":f"Bearer {access}"}) #user create
